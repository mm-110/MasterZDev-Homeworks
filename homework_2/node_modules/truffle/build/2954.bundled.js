...
const normalizeEntries = function (entries) {
    return __asyncGenerator(this, arguments, function* () {
        var _a, e_1, _b, _c;
        try {
            for (var _d = true, entries_1 = __asyncValues(entries), entries_1_1; entries_1_1 = yield __await(entries_1.next()), _a = entries_1_1.done, !_a;) {
            ...
            try {
                if (!_d && !_a && (_b = entries_1.return)) yield __await(_b.call(entries_1));
            }
            finally { if (e_1) throw e_1.error; }
        }
    });
...
const normalizeAsyncIterable = (content) => {
    return (function () {
        return __asyncGenerator(this, arguments, function* () {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, content_1 = __asyncValues(content), content_1_1; content_1_1 = yield __await(content_1.next()), _a = content_1_1.done, !_a;) {
                    _c = content_1_1.value;
                    _d = false;
                    try {
                        const bytes = _c;
                        yield yield __await(Buffer.from(bytes));
                ...
                try {
                    if (!_d && !_a && (_b = content_1.return)) yield __await(_b.call(content_1));
                }
...
const stringifyContainer = (container) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const entries = [];
    try {
        for (var _d = true, _e = __asyncValues(container.entries), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
            _c = _f.value;
            _d = false;
            try {
                const entry = _c;
...
const stringifyContent = (content) => { var _a, content_1, content_1_1; return __awaiter(void 0, void 0, void 0, function* () {
    var _b, e_2, _c, _d;
    const buffers = [];
    try {
        for (_a = true, content_1 = __asyncValues(content); content_1_1 = yield content_1.next(), _b = content_1_1.done, !_b;) {
            _d = content_1_1.value;
            _a = false;
            try {
                const piece = _d;
                buffers.push(piece);
        ...
        try {
            if (!_a && !_b && (_c = content_1.return)) yield _c.call(content_1);
        }
        finally { if (e_2) throw e_2.error; }
    }
