...
"use strict";
module.exports = JSON.parse('{"name":"@truffle/core","description":"Core code for Truffle command line tool","license":"MIT","author":"consensys.net","homepage":"https://github.com/trufflesuite/truffle#readme","repository":{"type":"git","url":"https://github.com/trufflesuite/truffle.git","directory":"packages/core"},"bugs":{"url":"https://github.com/trufflesuite/truffle/issues"},"version":"5.11.4","bin":{"truffle":"./cli.js","truffle-exec":"./exec.js"},"scripts":{"prepare":"exit 0","test":"mocha ./test/** ./test/**/*.js ./test/**/**/*.js"},"dependencies":{"@truffle/artifactor":"^4.0.198","@truffle/box":"^2.1.81","@truffle/code-utils":"^3.0.4","@truffle/codec":"^0.17.3","@truffle/compile-common":"^0.9.8","@truffle/compile-solidity":"^6.0.78","@truffle/config":"^1.3.61","@truffle/contract":"^4.6.30","@truffle/dashboard":"^0.4.4","@truffle/db-loader":"^0.2.35","@truffle/debug-utils":"^6.0.57","@truffle/debugger":"^12.1.4","@truffle/decoder":"^6.1.4","@truffle/deployer":"^3.3.26","@truffle/environment":"^0.2.159","@truffle/error":"^0.2.2","@truffle/expect":"^0.1.7","@truffle/fetch-and-compile":"^0.5.55","@truffle/from-hardhat":"^0.2.19","@truffle/hdwallet":"^0.1.4","@truffle/interface-adapter":"^0.5.37","@truffle/migrate":"^3.3.47","@truffle/plugins":"^0.2.15","@truffle/preserve":"^0.2.17","@truffle/promise-tracker":"^0.1.7","@truffle/provider":"^0.3.13","@truffle/provisioner":"^0.2.84","@truffle/require":"^2.1.42","@truffle/resolver":"^9.0.52","@truffle/source-fetcher":"^1.0.44","@truffle/spinners":"^0.2.5","@truffle/test":"^0.2.6","@truffle/workflow-compile":"^4.0.70","JSONStream":"^1.3.5","address":"^1.1.2","chai":"^4.2.0","colors":"1.4.0","command-exists":"^1.2.8","conf":"^10.0.2","debug":"^4.3.1","del":"^2.2.0","ethereum-cryptography":"1.1.2","fs-extra":"^9.1.0","ganache":"7.9.1","get-port":"^5.1.1","get-random-values":"^1.2.2","glob":"^7.1.6","inquirer":"8.2.2","iter-tools":"^7.5.0","js-interpreter":"2.2.0","lodash":"^4.17.21","mixpanel":"^0.17.0","mocha":"10.1.0","node-emoji":"^1.8.1","original-require":"^1.0.1","sane":"^4.0.2","semver":"^7.5.4","source-map-support":"^0.5.19","spawn-args":"0.2.0","tmp":"^0.2.1","uuid":"^9.0.0","web3":"1.10.0","web3-utils":"1.10.0","xregexp":"^4.2.4","yargs":"^13.3.0"},"devDependencies":{"@truffle/blockchain-utils":"^0.1.9","app-module-path":"^2.2.0","chai-as-promised":"^7.1.1","memorystream":"^0.3.1","sinon":"^9.0.2"},"publishConfig":{"access":"public"},"authors":[{"name":"Tim Coulter","email":"tim@trufflesuite.com","url":"https://github.com/tcoulter"}],"namespace":"consensys","engines":{"node":"^16.20 || ^18.16 || >=20"},"gitHead":"033fc64fcdf91ceef61100938d7ffbd53b63eee5"}');
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [5158,5784,1372,8074,6127,5674,6674,439,406,7657,6434,1324,8716,2765,5358,3983,5658,1698,6338,4886,4914,4877,6062,4738,5184,8569,553,4273,102,4317,7017,2478,8852], () => (__webpack_require__(489244)))
